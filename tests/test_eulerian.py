...
ep = sd.particle(x = -37.5, y = 10.4586420059204,z = -9.,t = 698155200.0,data = ecco)

def test_tz_not_None():
    ap = sd.position()
    ap.from_latlon(x = -37.5, y = 10.4586420059204,z = -9.,t = 698155200.0,data = avis)
...
def test_dict_input():
    ep._register_interpolation_input('SALT',
                                     {'SALT':uknw},
...
def test_diff_prefetched(varname,knw,prefetched):
    ep._register_interpolation_input(varname, knw,
